    ...
    <View style={{ paddingHorizontal: 10 }}>
      ...
      <View  style={[styles.flexEven]}>
        <View style={[styles.listWrapper]}>
          ...
          <View style={[styles.flexCenter]}>
            <Text
              style={[styles.modalPriceText, { color: '#ef233c'}]}
            >
        ...
        <View style={[styles.flexCenter]}>
          <Text
            style={[styles.rateText, { color: percentageChangeColor }]}
          >
             {price_change_percentage_24h.toFixed(3)}%
          </Text>
          <Text style={[styles.modalPriceSubText]}>change rate in 24 hours</Text>
        </View>
        </View>
      </View>
    </View>
